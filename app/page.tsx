    ...
    >
      ...
      <section className="relative z-10 px-6 py-14 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-black/80 border border-blue-900/40 rounded-2xl p-6">
            <div className="text-blue-200 font-bold text-lg mb-2">Normal</div>
            <div className="text-sm text-blue-100/70">Full clear</div>
          </div>

          <div className="bg-black/80 border border-blue-900/40 rounded-2xl p-6">
            <div className="text-blue-200 font-bold text-lg mb-2">Heroic</div>
            <div className="text-sm text-blue-100/70">Full clear</div>
          </div>

          <div className="bg-black/80 border border-blue-900/40 rounded-2xl p-6">
            <div className="text-blue-200 font-bold text-lg mb-2">Mythic</div>
            <div className="text-sm text-blue-100/70">
              All bosses except final encounter
            </div>
          </div>
        </div>
      </section>
